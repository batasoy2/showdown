...
class Top10Widget extends WP_Widget
{
    ...
    {
        parent::__construct('Top10Widget', 'ShowDown Top 10', ['description' => 'Shows the top 10 competitors on your site']);
    }

    public function form($instance)
    {
        $instance = wp_parse_args($instance, ['title' => '', 'type' => 'hotornot', 'number' => 5, 'group' => '']);
...
function register_top10_widget()
{
    register_widget('Top10Widget');
}

add_action('widgets_init', 'register_top10_widget');
?>
