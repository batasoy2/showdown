...
class TypeCompetitors
{
    ...
    public function __construct()
    {
        ...
        add_action('manage_edit-competitor_columns', array($this, 'competitor_edit_columns'));
        add_filter('the_content', array($this, 'post_append'));
    }

    public function registerCompetitors()
    {
        $labels = array(
            'name'                          => 'Groups',
            'singular_name'                 => 'Group',
        ...
        $competitorArgs = array(
            ...
            'hierarchical' => false,
            'rewrite' => array('slug' => 'competitors', 'with_front' => true),
            'has_archive' => true,
