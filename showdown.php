...
if (!class_exists("WPShowndown")) {
  class WPShowdown
  {
    ...
    function getOptions()
    {
      ...
      // default options
      $wpShowdownOptions = array(
        'header' => 'Click On The Best Photo You Want To Win This Battle.',
        'height' => 350,
        'width' => 397,
        'HONheight' => 350,
        'HONwidth' => 397,
...
?>
        <div class="updated">
          <p><strong><?php _e("Settings Updated.", "showdownplugin"); ?></strong></p>
        </div>
      <?php
      } ?>
    ...
    function printDesign()
    {
      ...
      <div class="wrap showdownplugininner submitpadding showdownstyling">
        ...
        <style>
          a.hon-preview {
            ...
            padding: 5px 10px;
            color: <?php echo $wpShowdownOptions['HONNumberStatic']; ?>;
          ...
          a.hon-preview:hover {
            color: <?php echo $wpShowdownOptions['HONNumberHover']; ?>;
	 ...
	 background-image: -webkit-linear-gradient(top, <?php echo $wpShowdownOptions['HONCapTopGradient']; ?>, <?php echo $wpShowdownOptions['HONCapBottomGradient']; ?>); 
	 background-image: -o-linear-gradient(top, <?php echo $wpShowdownOptions['HONCapTopGradient']; ?>, <?php echo $wpShowdownOptions['HONCapBottomGradient']; ?>); 
	 background-image: linear-gradient(to bottom, <?php echo $wpShowdownOptions['HONCapTopGradient']; ?>, <?php echo $wpShowdownOptions['HONCapBottomGradient']; ?>); padding: 5px 15px; display: inline; color: #fff;">Text Preview</p> / <p style="display: inline;"><a href="#" class="hon-preview">Numbers Preview</a></p>
        </div>
